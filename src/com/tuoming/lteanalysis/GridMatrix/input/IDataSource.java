...
public interface IDataSource {
	Map<String,GridInfo> LoadGrid(String lastDate);
	Map<String,GridInfo> LoadBeforeGrid();
	Map<String,Map<Long,GridBase>> LoadGridBase(String date);
	Map<String, GridLineList> LoadGridLineList(String date);
	...
	Map<Long,List<CoverStep>> LoadCoverStep(String date);
	...
	Map<String,SimulCover> LoadSimulCover(String date);
	Map<Long,CellUnit> LoadCellUnit(String date);
	
	Map<String,AnaGridData> LoadAnaGridData(String date,Map<Long, EngineerData> engdataMap);
}
